...
const AP_Param::GroupInfo NavEKF3::var_info2[] = {
    ...
    // @Param: GPSLOSS
    // @DisplayName: GPS yaw loss fallback delay (ms)
    // @Description: Time in milliseconds to wait after losing GPS yaw before falling back to magnetometer fusion.
    // @Range: 0 30000
    // @Units: ms
    // @User: Advanced
    AP_GROUPINFO("GPSLOSS", 12, NavEKF3, _gpsLossTimeout, 10000),

    // @Param: YAW_GPSRESET
    // @DisplayName: GPS yaw on-ground fusion timeout (ms)
    // @Description: Time in milliseconds of GPS yaw fusion timeout while on ground before requesting a yaw source reset.
    // @Range: 0 30000
    // @Units: ms
    // @User: Advanced
    AP_GROUPINFO("YAW_GPSRESET", 13, NavEKF3, _yawGpsReset, 10000),

    // @Param: YAWTHREEHOLD
    // @DisplayName: GPS/mag fallback sample threshold
    // @Description: Number of consecutive good magnetometer samples required before allowing mag fallback when GPS yaw is unavailable.
    // @Range: 1 200
    // @User: Advanced
    AP_GROUPINFO("YAWTHREEHOLD", 14, NavEKF3, _yawFallbackThreshold, 50),

    // @Param: GPSMAG_LRATE
    // @DisplayName: GPS mag bias learn rate
    // @Description: Rate at which magnetometer bias is learned from GPS yaw measurements. Increasing speeds up qualification for mag fallback.
    // @Range: 0.001 0.05
    // @User: Advanced
    AP_GROUPINFO("GPSMAG_LRATE", 15, NavEKF3, _gpsMagLearnRate, 0.005f),

    // @Param: GPSMAG_LLIM
    // @DisplayName: GPS mag learn error limit (Gauss)
    // @Description: Magnetometer error threshold in Gauss below which the mag is considered consistent with GPS yaw for fallback purposes. Increasing allows noisier mags to qualify.
    // @Range: 0.001 0.2
    // @Units: Gauss
    // @User: Advanced
    AP_GROUPINFO("GPSMAG_LLIM", 16, NavEKF3, _gpsMagLearnLimit, 0.02f),
